...
@software{nhavalde2024bioretro,
  ...
  year={2024},
  url={https://github.com/mayurOG/BIORETROSYNTHESIS},
  note={Multi-format input, reaction validation, performance optimizations}
}

@software{utekar2023transbioretro,
  title={TransBioRetro: Transformer-based Retrosynthesis},
...
- **Suyash Utekar** — Original TransBioRetro implementation
- **Meta AI** — ReactionT5v2 model development
- **KEGG/MetaCyc/USPTO** — Reaction datasets
